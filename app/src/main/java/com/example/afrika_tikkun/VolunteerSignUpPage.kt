...
import com.example.afrika_tikkun.databinding.ActivitySignUpPageVolunteerBinding
import com.google.firebase.auth.FirebaseAuth

class VolunteerSignUpPage : AppCompatActivity() {
    private lateinit var binding: ActivitySignUpPageVolunteerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySignUpPageVolunteerBinding.inflate(layoutInflater)
