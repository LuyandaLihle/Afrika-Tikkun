...
import com.example.afrika_tikkun.databinding.ActivityTeacherProfileBinding
...
class TeacherProfile : AppCompatActivity() {
    ...
    private fun getUserData() {
        ...
        databaseReference.child(uid).addValueEventListener(object : ValueEventListener{
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                hideProgressBar()
                Toast.makeText(this@TeacherProfile, "Failed to get user profile", Toast.LENGTH_SHORT).show()
            }
        })
    }
    ...
    private fun getTeacherProfile() {
        ...
        storageReference.getFile(localFile).addOnSuccessListener {
            ...
            hideProgressBar()
            Toast.makeText(this@TeacherProfile, "Failed to retrieve image", Toast.LENGTH_SHORT).show()
        }
    }

    private fun showProgressBar() {
        dialog = Dialog(this@TeacherProfile)
