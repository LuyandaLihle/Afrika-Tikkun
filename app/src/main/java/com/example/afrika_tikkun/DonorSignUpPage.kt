...
import com.example.afrika_tikkun.databinding.ActivitySignUpPageDonorBinding
import com.google.firebase.auth.FirebaseAuth

class DonorSignUpPage : AppCompatActivity() {
    private lateinit var binding: ActivitySignUpPageDonorBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySignUpPageDonorBinding.inflate(layoutInflater)
